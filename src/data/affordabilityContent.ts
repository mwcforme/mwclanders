...
export const FAQ_ITEMS = [
  { q: "Why doesn't MWC publish prices online?", a: "Because your treatment plan is built around your labs and your provider's recommendation. A flat published rate would either be misleading or force us to offer something that isn't right for your situation. Your provider reviews every cost in writing at your no-cost visit." },
  { q: "How much does TRT cost at MWC?", a: "Membership pricing depends on your therapy type, lab requirements, and the membership term you choose. Your provider reviews the full breakdown at your appointment. No-cost, no commitment." },
  ...
  { q: "Can I cancel my membership?", a: "12-month is our minimum term. 24-, 30-, and 36-month terms have specific cancellation terms reviewed at your appointment before you commit to anything." },
...
export const HOW_PRICING_CARDS: { Icon: LucideIcon; title: string; body: string }[] = [
  ...
  { Icon: Tag,          title: "New Member Offers",  body: "Limited promotions may reduce your first-month cost. Ask at your appointment." },
];
