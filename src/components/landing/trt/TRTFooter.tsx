        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
              ...
              {/* hardcoded-color-allow-next-line */}
              {li(<span>Newport News: <a href="tel:7578066263" style={{ color: "rgba(255,255,255,0.75)", textDecoration: "none" }}>757-806-6263</a></span>)}
              {/* hardcoded-color-allow-next-line */}
              {li(<span>Virginia Beach: <a href="tel:7576124428" style={{ color: "rgba(255,255,255,0.75)", textDecoration: "none" }}>757-612-4428</a></span>)}
              {/* hardcoded-color-allow-next-line */}
