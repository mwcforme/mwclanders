    ...
    <section id="results" style={{ background: "var(--brand-cream)" }}>
      <div className="max-w-[1200px] mx-auto px-6 py-12 md:py-24">
        <h2
          ...
          style={{ fontFamily: "Oswald, sans-serif", color: "var(--brand-navy)", fontSize: "clamp(26px, 3vw, 38px)", letterSpacing: "0.02em" }}
        >
          Real Members. Real Experiences.
        </h2>
        <p className="text-center mt-2" style={{ color: "var(--c-placeholder-light)", fontFamily: "Inter, sans-serif", fontSize: 15 }}>
          ...
          {TESTIMONIALS.map((t) => (
            <div
              ...
              style={{
                ...
                // hardcoded-color-allow-next-line
                boxShadow: "0 2px 16px rgba(11,16,41,0.07), 0 8px 32px rgba(11,16,41,0.05)",
              }}
            >
              ...
              <div className="mt-4 pt-4 border-t flex items-center justify-between" style={{ borderColor: "var(--c-border-on-light)" }}>
                <div>
                  <div className="font-semibold" style={{ color: "var(--brand-navy)", fontFamily: "Inter, sans-serif", fontSize: 16 }}>{t.name}</div>
        ...
        <div className="mt-10 text-center">
          <p className="mb-4" style={{ fontSize: 14, color: "var(--c-placeholder-light)", fontFamily: "Inter, sans-serif", fontStyle: "italic" }}>
