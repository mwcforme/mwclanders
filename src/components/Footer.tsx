...
const FooterHeading = ({ children }: { children: React.ReactNode }) => (
  <h4 className="uppercase mb-4 md:mb-5 font-semibold text-[13px] tracking-[0.1em]" style={{ color: "var(--c-text-on-dark)" }}>
    {children}
  </h4>
);
...
export const Footer = () => (
  <footer className="relative pb-16 lg:pb-0" style={{ background: "var(--brand-navy)" }}>
    {/* Glow divider */}
    <div
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8">
        ...
        <div>
          ...
          {[
            ...
            { name: "Newport News, VA", phone: "(757) 612-4428", to: "/locations/newport-news-va", tel: "7576124428" },
            { name: "Virginia Beach, VA", phone: "(757) 612-4428", to: "/locations/virginia-beach-va", tel: "7576124428" },
          ].map((loc) => (
